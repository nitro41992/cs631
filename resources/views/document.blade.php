...
<div class="container">
    ...
    <div class="container mb-3">
        <div class="row">
            <div class="col-sm">
                <form class="navbar-form" action="{{ route('document.filterId', ['id' => $id]) }}" method="GET"
                    role="search">
                    @csrf
            ...
            <div class="col-sm">
                <form class="navbar-form" action="{{ route('document.filterTitle', ['id' => $id]) }}" method="GET"
                    role="search">
                    <div class="input-group">
            ...
            <div class="col-sm">
                <form class="navbar-form" action="{{ route('document.filterPubName', ['id' => $id]) }}" method="GET"
                    role="search">
                    <div class="input-group">
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                ...
                <td> <a name="doc_select" href="{{ route('copy.index', 
                                    [
                                        'did' => $document->document_id,
                                        'id' => $id
                                    ]
                                ) }}" class="btn btn-primary btn-sm">Select
                        ({{$document->copy_count > 1 ? $document->copy_count.' copies' : $document->copy_count.' copy'}})</a>
                </td>
            </tr>
        </tbody>
        @endforeach
