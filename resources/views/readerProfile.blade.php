                ...
                <tr>
                    ...
                    <td>
                        <div class="row text-primary">
                            ...
                            <form class="m-1" method="POST" action="{{ route('readerProfile.return', 
                                        [    
                                            'id' => $id,
                                ...
                                <button type="submit" class="btn btn-outline-warning btn-sm text-nowrap">Return
                                    ({{ $copy->borrow_time_left.' left' }})</button>
                            </form>
