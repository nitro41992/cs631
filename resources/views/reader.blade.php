        ...
        <div class="row">
            ...
            <div class="col-sm">
                <form class="navbar-form" action="{{ route('reader.filterCardNum') }}" method="GET" role="search">
                    <div class="input-group">
                        <input type="number" class="form-control" placeholder="Search by Libary Card Number"
                            name="card_num">
                        <div class="input-group-btn">
                            <button class="btn btn-primary" type="submit">Search</button>
                        </div>
        ...
        <div class="card-body">
            <form class="mt-1" method="POST" action="{{ route('reader.insertReader') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="r_name" id="r_name" aria-describedby="r_name"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="card_num" id="card_num" aria-describedby="card_num" placeholder=""
                        type="text" pattern="\d*" maxlength="8" required>
                </div>
                <div class="form-group">
